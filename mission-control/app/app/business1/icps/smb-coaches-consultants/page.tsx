...
import { Briefcase, ArrowLeft, Bot, FileText } from "lucide-react";

export default function SMBCoachesConsultantsPage() {
  return (
    <div className="p-8 max-w-3xl">
      ...
      <div className="flex items-center gap-3 mb-2">
        <Briefcase size={24} className="text-cm-purple" />
        <h1 className="text-2xl font-bold tracking-tight text-dark-text">SMB Coaches & Consultants</h1>
        <span className="text-xs bg-dark-warn/20 text-dark-warn px-2 py-0.5 rounded-full font-medium">
          Research Pending
        </span>
      </div>
      <p className="text-dark-muted mb-8">
        Coaches and consultants running their practice and client relationships through WhatsApp.
      </p>
      ...
      <div className="bg-dark-bg border border-dark-border rounded-xl p-5">
        ...
        <p className="text-sm text-dark-muted font-mono font-dm-mono">
          ~/.attache/workspace/projects/business1/icps/smb-coaches-consultants.md
        </p>
      </div>
    </div>
  );
