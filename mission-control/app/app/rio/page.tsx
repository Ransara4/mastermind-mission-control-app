  ...
  return (
    <div className="p-8 max-w-3xl">
      <div className="flex items-center gap-3 mb-2">
        ...
        <h1 className="text-2xl font-bold tracking-tight text-dark-text">Rio</h1>
      </div>
      ...
      <div className="bg-dark-panel border border-dark-border rounded-xl p-5 mb-8">
        <p className="text-dark-muted text-sm font-medium mb-3">
          Most Rio information lives in the Rio Notion workspace.
        </p>
        <div className="flex items-center gap-3">
          ...
          <a
            ...
            title="Rio Slack channel not yet configured"
          >
            <Hash size={14} />
            Rio Slack
          </a>
      ...
      <div className="grid gap-3">
        ...
        <a
          href="https://rio-onboarding.vercel.app/"
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-4 p-4 bg-dark-panel border border-dark-border rounded-xl hover:border-cm-purple hover:shadow-sm transition-all"
        >
          ...
          <div className="flex-1">
            ...
            <div className="text-sm text-dark-muted">Interactive WABA onboarding flowchart — rio-onboarding.vercel.app</div>
          </div>
        </a>
      </div>
    </div>
