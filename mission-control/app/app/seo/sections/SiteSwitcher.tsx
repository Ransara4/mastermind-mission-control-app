...
import type { SeoSiteEntry } from "@/hooks/useSeoData";
...
const hostingColors: Record<string, string> = {
  ...
  netlify: "bg-cm-purple-mid/20 text-cm-purple-mid",
  aws: "bg-cm-pink/20 text-cm-pink",
  cloudflare: "bg-dark-warn/20 text-dark-warn",
};
...
export default function SiteSwitcher({ sites, selectedDomain, onSelect }: Props) {
  ...
  const selected = sites.find((s) => s.domain === selectedDomain);
