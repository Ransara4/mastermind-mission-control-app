...
export async function POST(req: NextRequest) {
  try {
    ...
    const answerPrompt =
      `You are ${ownerName} — a ${ownerRole}, founder, and automation nerd running the Business Automation Mastermind (Mastermind HQ). ` +
      ...
      "You now live in Bali, run a small business mastermind, and are genuinely obsessed with AI and automation. " +
