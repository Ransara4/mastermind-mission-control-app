...
const SETTINGS_PATH = path.join(WS, "data/mastermind-wrapup-settings.json");

const INSTRUCTIONS_PATH = path.join(WS, "projects/mastermind/cohort-1/FOLLOW-UP-PDF-INSTRUCTIONS.md");
