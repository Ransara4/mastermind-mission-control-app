...
const SCREENSHOTS_DIR = path.join(WS, "projects/rio/waba-setup/screenshots");
...
export async function POST(req: NextRequest) {
  try {
    ...
    const prompt = `Analyze this screenshot and determine if it is from a WABA (WhatsApp Business API) setup process, Meta Business Manager, Meta embedded signup flow, WhatsApp Business Account configuration, or the Rio platform (a WhatsApp SMB tool).
