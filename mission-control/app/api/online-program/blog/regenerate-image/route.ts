...
export async function POST(req: NextRequest) {
  try {
    ...
    // Run all three sources truly in parallel
    const [pexelsRaw, unsplashRaw, webRaw] = await Promise.all([
    ...
    // Order: Pexels first, Unsplash second, Web last
    const photos: Photo[] = [...pexelsPhotos, ...unsplashPhotos, ...webPhotos];
