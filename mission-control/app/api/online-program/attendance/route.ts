...
// GET /api/online-program/attendance?participant_id=X
// GET /api/online-program/attendance?session_number=N&cohort_number=1
...
// POST /api/online-program/attendance (upsert)
...
// DELETE /api/online-program/attendance?id=X
