...
// GET /api/online-program/wrap-up?session=N
...
// POST /api/online-program/wrap-up — create a new session
export async function POST(request: NextRequest) {
  try {
    ...
    const sessionData = {
      ...
      title: body.title || `${cohortLabel}, Session ${newNum}: Business Automation Online Program`,
      date: body.date || null,
      descript_link: null,
...
// PATCH /api/online-program/wrap-up?session=N
