...
const NIGHTCRAWLER_ROOT = path.join(WS, "agents/nightcrawler");
...
export async function POST(request: NextRequest) {
  ...
  if (action === "trigger") {
    // UI hook for manual trigger — placeholder
    return NextResponse.json({ ok: true, message: "Manual trigger acknowledged. Agent will run on next cycle." });
  }
